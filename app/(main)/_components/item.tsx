...
const Item = ({
  ...
  return (
    <div
      ...
      className={cn(
        " group min-h-[27px] w-full text-muted-foreground text-sm font-medium hover:bg-primary/5 flex items-center gap-x-2 py-1 pr-3",
    ...
    >
      ...
      {documentIcon ? (
        ...
        <Icon className=" shrink-0 w-[18px] h-[18px] text-muted-foreground" />
      )}
